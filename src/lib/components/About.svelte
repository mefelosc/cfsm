...
<div id="about" class="flex flex-col items-start space-y-4 py-16 px-6 md:px-24">
  ...
  <p class="max-w-xl text-left">
    Olá! Sou Carlos Felipe, um desenvolvedor de software atrás de criar soluções inovadoras e eficientes. Com experiência em diversas tecnologias, estou sempre em busca de novos desafios que me permitam crescer profissionalmente e contribuir para projetos impactantes.
  </p>
  <div id="socials" class="flex space-x-4 self-start md:self-auto">
    ...
    <path
      ...
      <a id="Email" class="transform transition-transform duration-100 hover:scale-130" target="_blank" href="mailto:cfsm.pj@gmail.com" aria-label="Settings">  
      <span class="[&>svg]:h-8 [&>svg]:w-8">
    ...
    <a id="Whatsapp" class="transform transition-transform duration-100 hover:scale-130" href="https://wa.me/34998132167" aria-label="Settings">
      <span class="[&>svg]:h-8 [&>svg]:w-8">
        <svg
          xmlns="http://www.w3.org/2000/svg"
          fill="currentColor"
