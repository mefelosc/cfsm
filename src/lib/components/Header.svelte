    ...
    <div class="navbar-center hidden lg:flex">
      <ul class="menu menu-horizontal px-1 font-medium text-sm gap-1">
        <li>
          <a
            href="#about"
            class="hover:bg-base-content/10 hover:text-primary rounded-full px-5 transition-colors"
            >Sobre</a
          >
        </li>
        <li>
    ...
    {#if open}
      ...
      >
        <a
          href="#about"
          on:click={() => (open = false)}
          class="btn btn-ghost w-full justify-start text-lg">Sobre</a
        >
        <a
          href="#projects"
          on:click={() => (open = false)}
          class="btn btn-ghost w-full justify-start text-lg">Projetos</a
        >
        <a
          href="#skills"
          on:click={() => (open = false)}
          class="btn btn-ghost w-full justify-start text-lg">Stack</a
        >
        <a
          href="{base}/cv2025.pdf"
          target="_blank"
