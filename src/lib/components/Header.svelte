  ...
  <header class="w-full  ">
    ...
    <nav> 
      ...
      <div class="{open ? 'block' : 'hidden'} w-full md:block md:w-auto" id="navbar-default">
        <ul class=" flex flex-col p-2 md:p-2 mt-2 md:flex-row md:space-x-0 rtl:space-x-reverse items-center justify-center navbar  ">
          ...
          <label class="flex cursor-pointer gap-2 color-gray-500 dark:text-gray-400 m-2">
            ...
            <input type="checkbox" value="synthwave" class="toggle theme-controller color-gray-500 dark:text-gray-400 " data-toggle-theme="dark,light"  data-act-class="ACTIVECLASS" />
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width="20"
              height="20"
